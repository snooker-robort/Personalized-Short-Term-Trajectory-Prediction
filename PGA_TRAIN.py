...
# io1 = r'C:\Users\斯诺克机器人\Desktop\GA_LSTM2\train_inputa1.xlsx'
# io2 = r'C:\Users\斯诺克机器人\Desktop\GA_LSTM2\train_inputb1.xlsx'
# io3 = r'C:\Users\斯诺克机器人\Desktop\GA_LSTM2\train_inputc1.xlsx'
# io4 = r'C:\Users\斯诺克机器人\Desktop\GA_LSTM2\train_outputa1.xlsx'
# io5 = r'C:\Users\斯诺克机器人\Desktop\GA_LSTM2\train_outputb1.xlsx'
# io6 = r'C:\Users\斯诺克机器人\Desktop\GA_LSTM2\train_outputc1.xlsx'
...
# datay1 = np.array(pd.read_excel(io4, header=None))
# datay2 = np.array(pd.read_excel(io5, header=None))
# datay3 = np.array(pd.read_excel(io6, header=None))
#
# np.save('dataxa1.npy',datax1)
# np.save('dataya1.npy',datay1)
# np.save('dataxb1.npy',datax2)
# np.save('datayb1.npy',datay2)
# np.save('dataxc1.npy',datax3)
# np.save('datayc1.npy',datay3)

trainData_X = np.load('dataxc1.npy')[:,0:14]
trainData_Y = np.load('datayc1.npy')
...
# Personal1.load_state_dict(torch.load('Personal_a4.pt'))
...
for epoch in range(250):
    ...
    for batch in range(n_batch):
        ...
        if epoch <=-1:
            ...
            cc2, _ = traffic(h, h1, h2, h3, h4, h5, h6)
            out = Personal1(cc2)
            ...
            # print('optimizera_loss:', loss1)
            if batch+1 == n_batch:
               print('optimizera_loss:',losssum/n_batch)
            optimizera.step()
    if epoch % 5 == 0 and epoch > 0:
    #     # torch.save(LsTM.state_dict(), 'LsTM.pt')
    #     # torch.save(traffic.state_dict(), 'Forward.pt')
    #     torch.save(Personal1.state_dict(), 'Personal_b8.pt')
        print('save success, and now iteration is', epoch)
torch.save(Personal1.state_dict(), 'Personal2_b1.pt')
# torch.save(LsTM.state_dict(), 'LsTM.pt')
# torch.save(traffic.state_dict(), 'Forward.pt')
